      ...
      <div className="container mx-auto">
        <div className=" rounded-md mt-5">
          <div className='flex flex-wrap justify-center'>
            ...
            : data.map((item, i) => (
              <div key={i} className='w-[300px] aspect-square m-3 group transition'>
                ...
                <img src={item.image[0]} alt="image" className="h-4/5 object-cover mx-auto my-1 group-hover:scale-110 transition duration-200 mb-3 pt-8"/>
