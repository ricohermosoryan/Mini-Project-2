    ...
    <>
      <PageTransition>
        <div className="container mx-auto">
          ...
          <p className="my-2">Understanding the importance of your privacy and the data given to us, <span className="font-semibold italic">QuantumGalaxy</span> has committed to the strict compliance of processing them based on this outline and in compliance with Republic Act 10173 or the Data Privacy Act of 2012 (DPA), along with its implementing rules and regulations (IRR). <span className="font-semibold italic">QuantumGalaxy</span>  shall regularly review the sufficiency and accuracy of this policy. We reserve the right to modify or change the privacy policy at any time.</p>

          <h2 className="mt-4 mb-1 underline">As to collection of data (Personal and Sensitive Information)</h2>

          <p className="my-2">By ordering/registering in <span className="font-semibold italic">QuantumGalaxy</span>, you voluntarily disclose to us personal data which may include sensitive personal information (such as: Name, Address, Emails, Contact Information, and alike). Such data attained will only be processed upon your express consent freely given and will only be used within a primary purpose of collection and other matters/concerns within the context allowed by the DPA and its IRR. Some of the uses, among others, are as follows:</p>
          <ul className="my-2">
            <li className="list-disc list-inside">Use, access and denial access (if data would show that <span className="font-semibold italic">QuantumGalaxy</span> does not cater to a certain individual – i. minors and infringers) of <span className="font-semibold italic">QuantumGalaxy</span> online and its services;</li>
          ...
          <p className="my-2"><span className="font-semibold italic">QuantumGalaxy</span> may use cookies and other online technologies in the storage of data aimed to provide a better experience in using our website and other platforms.</p>

          <h2 className="mt-4 mb-1 underline">Spams, Viruses and Spywares or other security threats</h2>

          <p className="my-2"><span className="font-semibold italic">QuantumGalaxy</span> does not tolerate Spams, Viruses and Spywares. Likewise, we request from you to not use any email or accounts which may contain the same. For any suspicion on your messages and emails, please do contact us in the information as provided in the “Complaints Section” below.</p>

          <h2 className="mt-4 mb-1 underline">Security of Your Personal Information</h2>

          <p className="my-2"><span className="font-semibold italic">QuantumGalaxy</span> ensures that all information collected will be safely and securely stored. We protect your personal information by:</p>
          <ul className="my-2">
          ...
          <p className="my-2">If you believe that your privacy has been breached by <span className="font-semibold italic">QuantumGalaxy</span>, please contact us at our e-mail address below.</p>

          <p className="my-2">Your password is the key to your account. Please use unique numbers, letters and special characters, and do not share your <span className="font-semibold italic">QuantumGalaxy</span> password to anyone. If you do share your password with others, you will be responsible for all actions taken in the name of your account and the consequences. If you lose control of your password, you may lose substantial control over your personal information and other information submitted to <span className="font-semibold italic">QuantumGalaxy</span>. You could also be subject to legally binding actions taken on your behalf. Therefore, if your password has been compromised for any reason or if you have grounds to believe that your password has been compromised, you should immediately contact us and change your password. You are reminded to log off of your account and close the browser when finished using a shared computer.</p>
          ...
          <p className="my-2"><span className="font-semibold">Right to Inquiry:</span> Data subjects may inquire or request for information regarding any matter relating to the processing of their personal data under the custody of <span className="font-semibold italic">QuantumGalaxy</span>, including the data privacy and security policies implemented to ensure the protection of their personal data. They may write to <span className="font-semibold italic">QuantumGalaxy</span> at <a href="mailto:dataprivacy@quantumgalaxy.com" className="text-dark-quantum hover:text-quantum">dataprivacy@quantumgalaxy.com</a> and briefly discuss the inquiry, together with their contact details for reference.</p>

          <p className="my-2"><span className="font-semibold">Complaints:</span> Complaints shall be filed in three (3) printed copies, or sent to <a href="mailto:dataprivacy@quantumgalaxy.com" className="text-dark-quantum hover:text-quantum">dataprivacy@quantumgalaxy.com</a>. The concerned department or unit shall confirm with the complainant its receipt of the complaint.</p>
