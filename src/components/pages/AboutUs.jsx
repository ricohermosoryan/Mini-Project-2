    ...
    <>
      <PageTransition>
        ...
        <div className="text-xl font-medium flex justify-center mt-[130px] mb-9 text-center md:mt-[200px] lg:mt-[360px] lg:text-[30px] lg:font-semibold">
          Welcome to QuantumGalaxy, where we bring the future to your
          fingertips.
        </div>
        <div className="container mx-auto">
          ...
          <div className="text-xl font-normal mb-7 ms-3 lg:ms-10">
            ...
            universe of gadgets and gizmos, we believe in reaching for the
            stars, both figuratively and literally.
          </div>
          <div className="heading text-[32px] font-semibold mb-7">
            Your Gateway to the Future
          </div>
          <div className="text-xl font-normal mb-7 ms-3 lg:ms-10">
            Our store is more than just a place to buy the latest gadgets; it's
            a portal to the QuantumGalaxy. We curate a universe of cutting-edge
          ...
          <div className="text-xl font-normal mb-8 ms-3 lg:ms-10">
            ...
            unknown, and embrace the infinite possibilities that technology has
            to offer. Your journey to the QuantumGalaxy starts here.
            <br />
            <br />
